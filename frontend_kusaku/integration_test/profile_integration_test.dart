...
_MockRouteResponse _routeResponse(String method, Uri uri) {
  ...
  if (method == 'GET' && path.contains('/expenses/')) {
    return const _MockRouteResponse(200, '[{"kusaku_points":100,"receiver":"Warung","date":"2025-05-15T10:00:00"}]');
  }
...
void main() {
  ...
  group('Profile integration', () {
    ...
    testWidgets('navigates to reward pages', (tester) async {
      ...
      await tester.tap(find.text('Kusaku Points'));
      await tester.pumpAndSettle();
      ...
      await tester.tap(find.text('Keuntungan Pakai Kusaku'));
      await tester.pumpAndSettle();
      expect(find.text('Keuntungan Pakai Kusaku'), findsOneWidget);
